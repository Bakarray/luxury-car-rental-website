...
import type { Testimonials } from "../types/global";
...
const Testimonial = () => {
  const testimonials: Testimonials[] = [
    ...
    },
    {
      ...
      testimonial:
        "Car Rental made my trip so much easier. The car was dilivered right to my door, and the customer service was fantastic!",
    },
    {
      name: "Ava Johnson",
